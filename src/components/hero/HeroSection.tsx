...
import { CollaborationStrip, HeroMediaColumn } from '@/components/shared';
...
export default function HeroSection(props: HeroSectionProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className="full-bleed relative overflow-x-clip overflow-y-visible bg-surface max-md:pt-15 pb-15 md:pt-29 md:pb-0 lg:pt-17"
    ...
    >
      ...
      <div className="site-container relative z-10">
        ...
        <div className="relative -mt-10 md:-mt-12">
          <CollaborationStrip collaboration={collaboration} />
        </div>
      </div>
    </section>
  );
