    ...
    <article className={TRAINER_CARD}>
      ...
      <div className="mt-4 flex w-full items-center gap-2.5 rounded-lg bg-[#F5F6F8] px-3 py-2 text-left">
        ...
        <span>
          ...
          <span className="block text-[12px] font-semibold leading-normal text-heading">
            {experienceValue}
          </span>
        </span>
      </div>
