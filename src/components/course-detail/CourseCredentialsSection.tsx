...
import type { CourseCredentialsContent } from '@/lib/courseBody';
...
export default function CourseCredentialsSection({
  ...
  return (
    <div
      className={`${COURSE_SECTION_CARD} px-6 py-5 md:px-8 md:py-6`}
    >
      ...
      <div className="relative mx-auto mt-[100px] flex max-w-[650px] justify-center">
        ...
        <div className="relative z-10 w-full max-w-[650px]">
          <Image
            ...
            alt={credentials.certificateImageAlt}
            width={650}
            height={495}
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-3 md:gap-8">
        {credentials.features.map((feature) => (
