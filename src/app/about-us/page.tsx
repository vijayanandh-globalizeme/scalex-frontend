      ...
      <section className="full-bleed bg-white max-md:pt-15 pb-0 md:pb-10 md:pt-20">
        <div className="site-container">
          <div className="mb-12 text-center">
            ...
            >
              A career-focused learning platform built to help learners and professionals<br /> 
              develop industry-relevant skills for today’s evolving job market.
            </p>
          </div>
          <div className="grid items-start gap-4 lg:gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              >
                EdgeX Learning provides live, expert-led programs across <strong>DevOps, Automation Testing, Data Science, Artificial Intelligence, Project Management, Agile and Scrum </strong>.
              </p>
              <p className="mt-4" style={{ color: '#4A5867', fontFamily: 'Inter', fontSize: '15px', fontStyle: 'normal', fontWeight: 400, lineHeight: '24px' }}>
                Our programs combine structured learning, practical application, hands-on projects and career-focused support to help learners build skills that are relevant to real-world industry requirements.
              </p>
              <p className="mt-4" style={{ color: '#4A5867', fontFamily: 'Inter', fontSize: '15px', fontStyle: 'normal', fontWeight: 400, lineHeight: '24px' }}>
                We go beyond course completion by supporting learners with <strong>interview preparation, career guidance and job assistance</strong>, helping them move forward with greater confidence.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="full-bleed bg-white pb-15 pt-0 md:py-10">
        <div className="site-container">
          <div className="mb-12 mt-12 text-center">
            ...
            >
              We help learners build practical skills, prepare for career opportunities <br />
              and stay relevant in a rapidly changing industry
            </p>
          </div>
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-8">
              {[
                { title: 'Industry-Relevant Training', desc: 'Programs designed around current industry requirements, tools and skills.' },
                { title: 'Live Expert-Led Learning', desc: 'Interactive live sessions delivered by experienced industry professionals.' },
                { title: 'Hands-On Learning', desc: 'Practical assignments, projects and real-world scenarios that turn concepts into skills.' },
                { title: 'Interview Preparation', desc: 'Dedicated preparation with mock interviews, practice sessions, resume support and expert guidance.' },
                { title: 'Career & Job Assistance', desc: 'End-to-end support to help learners prepare, apply and confidently approach career opportunities.' },
                { title: 'Enterprise Training', desc: 'Customized learning and upskilling solutions designed to meet organizational and workforce needs.' },
              ].map((item) => (
        ...
        <div className="site-container">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              {
                title: 'Our Mission',
                description: 'To make career-focused learning practical, accessible and outcome-driven, helping learners build industry-relevant skills, gain real-world experience and prepare confidently for career opportunities.',
              },
              {
                title: 'Our Vision',
                description: 'To become a trusted learning partner for individuals and organizations by creating high-quality, industry-relevant learning experiences that help people continuously learn, grow and stay ahead in their careers.',
              },
            ].map((card) => (
      ...
      <section className="full-bleed bg-surface pb-15 max-md:pt-15 md:pb-20 md:pt-20">
        <div className="site-container">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { logo: '/images/the-eco.png', logoAlt: 'The Economic Times', date: 'September 2026', content: 'The EdTech platform focuses on practical learning, interview readiness and career support for aspiring professionals.', title: 'EdgeX Learning Makes Career-Focused Tech Education More Accessible'},
              { logo: '/images/yours.png', logoAlt: 'YourStory', date: 'September 2026', content: 'The Bengaluru-based EdTech startup combines live learning, hands-on training and career preparation.', title: 'EdgeX Learning Takes a Career-First Approach to Professional Upskilling' },
              { logo: '/images/inc.png', logoAlt: 'Inc42', date: 'October  2026', content: 'The platform offers programs across DevOps, AI, Data Science, Automation Testing, Project Management, Agile and Scrum.', title: 'EdgeX Learning Bets on Industry-Relevant Skills to Prepare Learners for New-Age Careers' },
              { logo: '/images/bussine.png', logoAlt: 'Business Standard', date: 'October  2026', content: 'The company aims to bridge the gap between professional learning, practical skills and career readiness.', title: 'EdgeX Learning Expands Its Portfolio of Career-Focused Learning Programs' },
            ].map((item) => (
              <div key={item.logoAlt} className="interactive-card flex flex-col rounded-2xl border border-zinc-100 bg-white p-6">
                ...
                <p className="interactive-card-title mt-2 flex-1" style={{ color: '#788593', fontFamily: 'Inter', fontSize: '12px', fontStyle: 'normal', lineHeight: 'normal' }}>
                  {item.content}
                </p>
                <p className="mt-4" style={{ color: '#788593', fontFamily: 'Inter', fontSize: '13px', fontWeight: 400 }}>{item.date}</p>
