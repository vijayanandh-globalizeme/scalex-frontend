  ...
  return {
          ...
          stages: [
            {
              ...
              projects: [
                { company: 'Yulu', projectName: 'Ride Demand AI' },
                { company: 'Bajaj Insurance', projectName: 'Cross - Sell AI' },
                { company: 'Kindle', projectName: 'Smart Recommender' },
                { company: 'Myntra', projectName: 'Retail Clustering Engine' },
                { company: 'Ola', projectName: 'Surge AI' },
                { company: 'Bajaj Insurance', projectName: 'Cross - Sell AI' },
              ],
    ...
    careerAssurance: isPrimary
      ? {
          ...
          imageSrc: '/images/hero/person-1.png',
